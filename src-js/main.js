...
// TODO: add event listener for sides touch slide
function navClick (e) {
  var id = e.target.id
...
portfolioNav.click(debounce(navClick, 200))
btnNext.click(debounce(handleNext, 200))
btnPrev.click(debounce(handlePrev, 200))
